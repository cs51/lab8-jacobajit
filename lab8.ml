...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let id_curr = new_id () in
    evt := {id = id_curr; action = listener} :: !evt;
    id_curr
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun waiter -> waiter.id <> i) !evt
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    List.iter (fun waiter -> waiter.action arg) !evt
...
let _ = WEvent.remove_listener newswire l1 ;;
let _ = WEvent.remove_listener newswire l2 ;;
